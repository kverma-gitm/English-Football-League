...
myApp.controller('firstcontroller', ['$http', '$q', function($http, $q) {
    var main = this;
    this.combinedData = [];
    this.loadAllData = function() {
        ...
        $q.all([main.firstJson, main.secondJson]).then(function successCallback(response1) {
            ...
            main.firstJsonRounds = response1[0].data.rounds;
            main.secondJsonRounds = response1[1].data.rounds;
            main.combinedData = main.combinedData = response1[0].data.rounds.concat(response1[1].data.rounds);
...
myApp.controller('secondcontroller', ['$http', '$q', '$routeParams', function($http, $q, $routeParams) {
    var main = this;
    this.combinedData = [];
